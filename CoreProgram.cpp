          ...
          if (taxiCount < maxVehicleCount) //if  taxi count is less that maxvehiclecount, then only we can add
            {
                ...
                cout<<"\nEnter UID of Taxi: "
                fflush(stdin);
                cin>>taxi[taxiCount].UID;
                cout<<"\nEnter Name of Driver: "
                fflush(stdin);
                cin>>taxi[taxiCount].Name;
                cout<<"\nEnter Mobile no. of Driver: "
                fflush(stdin);
  ...
  int choice = 0.id;
    ...
    if (userMode == 3 || userMode == 4) //if user is staff or admin, then only allowed to edit
    {
        ...
        case 1: //remove bike
        {
          ...
          if (bikeCount == 0)
         {
            cout << "Bikelist is empty ! Nothing to Delete !" << endl;
         }
         else
          {
            ...
            else
            {
                ...
                else
                {
                    ...
                    for (int i = flag; i < bikeCount - 1; i++)
                    {
                        ...
                        tempnp = bike[i].Date_Birth;
                        bike[i].Date_Birth= bike[i+1].Date_Birth;
                        bike[i+1].Date_Birth = tempnp;
            ...
            else
            {
                ...
                else
                {
                    ...
                    for (int i = flag; i < taxiCount - 1; i++)
                    {
                        ...
                        tempnp = taxi[i].Date_Birth;
                        taxi[i].Date_Birth= taxi[i+1].Date_Birth;
                        taxi[i+1].Date_Birth = tempnp;
